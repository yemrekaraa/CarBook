...
namespace CarBook.WebApi.Controllers
{
    ...
    public class BannersController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateBanner(CreateBannerCommand coomand)
        {
            await _createBannerCommandHandler.Handle(coomand);
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateBanner(UpdateBannerCommand coomand)
        {
            await _updateBannerCommandHandler.Handle(coomand);
